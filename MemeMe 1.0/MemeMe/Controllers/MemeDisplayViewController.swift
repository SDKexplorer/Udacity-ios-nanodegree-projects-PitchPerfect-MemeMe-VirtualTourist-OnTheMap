...
class MemeDisplayViewController: UIViewController, UIImagePickerControllerDelegate,
UINavigationControllerDelegate, UITextFieldDelegate {
    ...
    var image: UIImage? {
        ...
        set(value) {
            _image = value
            shareButton.isEnabled = value == nil ? false : true
        }
    }
    ...
    @IBAction func save() {
        ...
        if let selectedImage = imagePresenter.image {
            ...
            avc.completionWithItemsHandler = { activity, success, items, error in
                if success {
                    let _ = Meme(topText: self.topTextField.text!, bottomText: self.bottomTextField.text!, memedImage: memedImage, originalImage: selectedImage)
                }
            }
